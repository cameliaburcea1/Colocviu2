...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // create an on click listner with lambda expression
        ...
        // create an on click listener with lambda expression
        imageButton.setOnClickListener(view -> {
            imgView = findViewById(R.id.img_view);
            String url = "https://imgs.xkcd.com/comics/physical_quantities_2x.png";
            new ImageLoadTask(imgView).execute(url);
        });
        ...
        getWeatherForecastButton.setOnClickListener(view -> {
